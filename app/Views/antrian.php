    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" onclick="proses()" id="proses">Memasak</button>
            </div>
        </div>
    </div>
</div>
            ...
            success: function(data) {
                if (data.length) {
                    for (let i = 0; i < data.length; i++) {
                        ...
                        if (data[i].status == 0) {
                            isiPesanan += "<label class='badge badge-danger'>Memasak"
                        } else {
                            isiPesanan += "<label class='badge badge-success'>Bayar"
                        }
